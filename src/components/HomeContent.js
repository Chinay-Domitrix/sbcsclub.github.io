...
export default class HomeContent extends Component {
  ...
  componentDidMount() {
    ...
    document
      .getElementById("home-title")
      .addEventListener("webkitAnimationEnd", this.transitionEnd);
    document
  ...
  render() {
    ...
    if (document.getElementById("description")) {
      document.getElementById("description").style.opacity =
        1 - ((500 - this.state.scroll) * (200 - this.state.scroll)) / 30000;
    }

    if (
      this.state.scroll > 190 &&
      !document.getElementById("description").classList.contains("after")
    ) {
    ...
    return (
      <div className="center">
        <div id="home-title">SBHS Computer Science Club</div>
        <div id="description">
        ...
        <div id="workshops-description" className="center">
          <div id="workshops-title">Workshops</div>

          <div id="workshops-list" className="grid">
            {workshops.map(
              ({ name, leads, description, difficultyLevel }, i) => {
                return (
                  <Workshop
                    key={i}
                    name={name}
